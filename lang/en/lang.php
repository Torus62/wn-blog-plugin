...
return [
    'plugin' => [
        'name' => 'News',
        'description' => 'A robust news platform.'
    ],
    'blog' => [
        'menu_label' => 'News',
        'menu_description' => 'Manage News Articles',
        'posts' => 'Posts',
        ...
        'manage_settings' => 'Manage news settings',
        'delete_confirm' => 'Are you sure?',
        'chart_published' => 'Published',
        'chart_drafts' => 'Drafts',
        'chart_total' => 'Total',
        'settings_description' => 'Manage news settings',
    ...
    'menuitem' => [
        ...
        'all_blog_categories' => 'All news categories',
        'blog_post' => 'News post',
        'all_blog_posts' => 'All news posts',
        'category_blog_posts' => 'News category posts'
    ],
    'settings' => [
        ...
        'rssfeed_description' => 'Generates an RSS feed containing posts from the news.',
        'group_links' => 'Links',
